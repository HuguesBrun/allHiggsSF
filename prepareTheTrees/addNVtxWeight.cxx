...
void addNVtxWeight(TString treeName="tpTree", TString cut = "") { //, TString cut="(tag_IsoMu24_eta2p1 || tag_IsoMu24) && tag_combRelIso < 0.15") {
    ...
    Float_t tag_nVertices, weight;
    tMC.SetBranchAddress("tag_nVertices", &tag_nVertices);
    TFile *fOut = new TFile("/tmp/hbrun/TnP_MCwithPU.root", "RECREATE");
    //TFile *fOut = new TFile("/afs/cern.ch/work/h/hbrun/pogTnPr7Top/TnP_DY.root", "RECREATE");
